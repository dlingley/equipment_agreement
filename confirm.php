...
function sendAgreementEmail($email, $firstName, $lastName) {
    ...
    try {
        ...
        $message .= "User Agreement Details:\n";
        ...
        $message .= "• Keep the Knowledge Lab and everything within the facility clean and organized. If you take out tools and materials, return them to the correct location and clean up the area used. If equipment or a tool is broken or not functioning correctly, please notify staff immediately.\n";
        $message .= "• Be respectful to Knowledge Lab staff, other users of the Knowledge and towards its equipment at all times.\n";
        $message .= "• Staff are available to assist patrons with equipment use, understanding materials and processes, and talking through ideas and project concepts for you to complete the work yourself.\n";
        $message .= "• Staff have the right to refuse projects and material usage if they are in violation of Knowledge Lab policies.\n";
        $message .= "• Users are responsible for properly monitoring and labeling anything brought into the lab and the Knowledge Lab is not responsible for any lost, damaged, or stolen property.\n\n";

        $message .= "Use of the Knowledge Lab and materials created will not be:\n";
        $message .= "• Prohibited by local, state, or federal law.\n";
        $message .= "• Unsafe, harmful, dangerous, or pose an immediate or perceived threat to the well-being of others.\n";
        $message .= "• Obscene or otherwise inappropriate for the University and Library environment.\n";
        $message .= "• In violation of intellectual property rights.\n\n";
